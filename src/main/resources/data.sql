...
-- 🧪 테스트용 공유 APIs
('shared-test-001', 'api-test-001', 'test-user-001', 'Public Weather API', 'Free weather data for testing', 120, true, '2024-12-05 10:00:00', '2024-12-05 10:00:00'),
('shared-demo-001', 'api-demo-001', 'demo-user-001', 'Calculator Service', 'Demo calculation service', 85, true, '2024-12-05 11:00:00', '2024-12-05 11:00:00'),

-- 🆓 FREE 사용자들의 공유
('shared-free-001', 'api-free-001', 'free-user-001', 'Community Weather', 'Community weather service', 95, true, '2024-12-20 10:00:00', '2024-12-20 10:00:00'),
('shared-free-002', 'api-free-004', 'free-user-003', 'Code Examples Library', 'Programming snippets collection', 156, true, '2024-12-20 16:00:00', '2024-12-20 16:00:00'),
('shared-free-003', 'api-free-005', 'free-user-003', 'Git Commands Helper', 'Git command reference API', 203, true, '2024-12-21 09:00:00', '2024-12-21 09:00:00'),

-- 💎 PRO 사용자들의 공유 (고품질 서비스)
('shared-pro-001', 'api-pro-001', 'pro-user-001', 'Business Analytics Suite', 'Professional analytics tools', 847, true, '2024-11-15 11:00:00', '2024-11-15 11:00:00'),
('shared-pro-002', 'api-pro-005', 'pro-user-002', 'Enterprise Auth System', 'Enterprise-grade authentication', 562, true, '2024-11-20 14:30:00', '2024-11-20 14:30:00'),
('shared-pro-003', 'api-pro-006', 'pro-user-002', 'Data Processing Pipeline', 'Big data processing service', 731, true, '2024-11-25 16:00:00', '2024-11-25 16:00:00'),
('shared-pro-004', 'api-pro-008', 'pro-user-003', 'Startup KPI Tracker', 'Startup metrics dashboard', 394, true, '2024-11-30 12:00:00', '2024-11-30 12:00:00'),

-- 🔄 플랜 변경 사용자들의 공유
('shared-switch-001', 'api-switch-001', 'switcher-001', 'Stock Insights Pro', 'Advanced stock analysis', 425, true, '2024-11-10 12:00:00', '2024-11-10 12:00:00'),
('shared-switch-002', 'api-switch-004', 'switcher-002', 'Growth Analytics', 'Business growth tracking', 287, true, '2024-12-01 15:00:00', '2024-12-01 15:00:00');
...
('saved-free-004', 'free-user-004', 'shared-pro-002', 'Auth System Study', 'Learning authentication', 15, false, '2024-12-23 10:00:00', '2024-12-23 10:00:00'),
...
💎 **PRO 플랜 테스트 사용자들:**
- pro-user-001~004: 실제 Stripe 구독 ID 포함
...
- qa-test-001: QA 테스트 (PRO with Stripe)
...
5. **Stripe 결제 연동**: pro-user들의 실제 구독 ID 활용
